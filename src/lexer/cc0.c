...
TokenType_t operatorTypes[] = {
  ...
  {SET_LEXEME_LEN("*="), TOKEN_TYPE_NAME(T_MULEQ), 0},
  {SET_LEXEME_LEN("/="), TOKEN_TYPE_NAME(T_DIVEQ), 0},
  {SET_LEXEME_LEN("%="), TOKEN_TYPE_NAME(T_MODEQ), 0},
  {SET_LEXEME_LEN("+"), TOKEN_TYPE_NAME(T_PLUS), 0},
  {SET_LEXEME_LEN("-"), TOKEN_TYPE_NAME(T_MINUS), 0},
  {SET_LEXEME_LEN("*"), TOKEN_TYPE_NAME(T_MUL), 0},
  {SET_LEXEME_LEN("/"), TOKEN_TYPE_NAME(T_DIV), 0},
  {SET_LEXEME_LEN("%"), TOKEN_TYPE_NAME(T_MOD), 0},
  {SET_LEXEME_LEN("="), TOKEN_TYPE_NAME(T_ASSIGN), 0},
  {SET_LEXEME_LEN("<"), TOKEN_TYPE_NAME(T_LT), 0},
  {SET_LEXEME_LEN(">"), TOKEN_TYPE_NAME(T_GT), 0},
